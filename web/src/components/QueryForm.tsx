...
// {query, model_version}) — retrieval_agent.py always searches all
// configured vector stores. This lists them as informational context
// (mirroring ui_rag_full_advanced.py's regulator multiselect in spirit)
// rather than offering a filter control the backend can't honor yet.
const REGULATORS = ["CSSF", "DORA", "EBA", "NIS2"];
...
// questions. Picked to span all four live-searched regulators plus one
...
const SAMPLE_QUERIES = [
  ...
  "What are the cybersecurity risk-management measures required for essential and important entities under NIS2?",
];
